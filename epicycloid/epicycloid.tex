...
\centering\begin{tikzpicture}[scale=.075,>=stealth]\FinalConstruction\SelectedGeometry\PtoCpArc\draw[contact line](O)--(Cp);\NormalLine\PGeometry\fill[black](M)circle(1.3pt)node[above right]{$M$};\fill[black](Cp)circle(1.3pt);\Legend{$NN'$: normal.}\end{tikzpicture}
\end{frame}
